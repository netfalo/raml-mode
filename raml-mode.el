(defconst raml-mode-version "0.0.2" "Version of `raml-mode`.")

(defvar raml-mode-hook nil)
(add-to-list 'auto-mode-alist '("\\.raml\\'" . raml-mode))

(defvar raml-indent-offset 4 "Indent offset for RAML mode")
...
(define-derived-mode raml-mode yaml-mode "RAML mode"
